...
Start-Process -FilePath $pythonExe -ArgumentList '-m','uvicorn','server:app','--host','0.0.0.0','--port','8000' -WorkingDirectory $scriptDir -RedirectStandardOutput $out -RedirectStandardError $err -WindowStyle Normal
